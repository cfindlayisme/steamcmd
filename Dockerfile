...
RUN \
    apt-get update && \
    apt-get install -y  apt-get install -y screen=4.9.0-4 lib32gcc-s1=12.2.0-14 libc6-i386=2.36-9+deb12u7 ca-certificates=20230311 &&apt-get install -y screen=4.9.0-4 lib32gcc-s1=12.2.0-14 libc6-i386=2.36-9+deb12u7 ca-certificates=20230311 && \
    apt-get clean && \
